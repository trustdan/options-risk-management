<script>
  ...
  import GlobalPositionBar from './components/shared/GlobalPositionBar.svelte';
...
<main class:dark-mode={isDarkMode}>
  ...
  <a href="https://github.com/trustdan/options-risk-management" target="_blank" class="github-corner" aria-label="View source on GitHub">
    <svg width="80" height="80" viewBox="0 0 250 250" style="fill:{isDarkMode ? '#f05252' : '#38b2ac'}; color:#fff; position: absolute; top: 32px; border: 0; right: 0;" aria-hidden="true">
